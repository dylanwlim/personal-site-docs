...
The token should be a fine-grained GitHub token with Contents read/write access only to `dylanwlim/personal-site-docs`. Do not grant access to the private source repository or any unrelated repository.
